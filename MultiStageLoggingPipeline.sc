...
// JK: In hind-sight this is the wrong way of doing things.
// Now diskActor and logger are both children of the testKit.
// While the diskActor should be a child of the logger.
//
// I improved on this in NonLinearLoggingPipeline.sc
